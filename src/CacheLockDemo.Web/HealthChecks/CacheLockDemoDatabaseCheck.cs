...
public class CacheLockDemoDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public CacheLockDemoDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
